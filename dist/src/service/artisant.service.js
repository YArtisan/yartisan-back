...
async function createArtisantService(request, res) {
    try {
...
async function updateArtisantService(request, res) {
    try {
...
async function deleteArtisantService(request, res) {
    try {
        if (!request.artisant_id) {
            res.status(400).json({ status: false, message: "Artisan id is undefined" });
            return;
...
async function getArtisantDataService(request, res) {
    try {
...
async function getAllArtisansDataService(res) {
    try {
        ...
        const artisansWithOpeningAndRating = await Promise.all(artisanData.map(async (artisan) => {
