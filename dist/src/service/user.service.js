...
async function createUserService(request, res) {
...
async function updateUserService(request, res) {
    try {
        const updatedData = {
            firstname: request.firstname,
            lastname: request.lastname,
...
async function deleteUserService(request, res) {
    try {
...
async function getUserDataService(request, res) {
    try {
        const userId = request.user_id;
